...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260506183723_GlobalSearchHistory")]
    partial class GlobalSearchHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SEM.Domain.Models.EventChatAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("EventChatAttachments");
                });

            modelBuilder.Entity("SEM.Domain.Models.EventChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SEM.Domain.Models.EventSelectedType", b =>
                {
                    b.Property<Guid>("EventId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("EventId", "TypeKind");

                    b.ToTable("EventSelectedTypes");
                });
            ...
            modelBuilder.Entity("SEM.Domain.Models.SearchQueryHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SEM.Domain.Models.BoardTask", b =>
                {
                    b.HasOne("SEM.Domain.Models.User", "AssignedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SEM.Domain.Models.EventChatAttachment", b =>
                {
                    b.HasOne("SEM.Domain.Models.EventChatMessage", "Message")
                        .WithMany("Attachments")
            ...
            modelBuilder.Entity("SEM.Domain.Models.EventChatMessage", b =>
                {
                    ...
                    b.HasOne("SEM.Domain.Models.EventChatMessage", "ReplyToMessage")
                        .WithMany()
