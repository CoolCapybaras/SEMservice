...
{
    Task<ServiceResult<BoardTaskDto>> CreateTaskAsync(Guid columnId, string title, string? description, Guid? assigneeId, DateTime? deadline, Guid userId, BoardTaskPriority? priority = null);
