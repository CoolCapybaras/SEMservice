...
public static class EventTypeKindParser
{
    public static bool TryParse(string? raw, out EventTypeKind kind)
    {
        ...
        if (lower.Contains("вебинар") || lower.Contains("webinar")) { kind = EventTypeKind.Webinar; return true; }
        if (lower.Contains("урфу") || lower == "urfu") { kind = EventTypeKind.UrFU; return true; }
